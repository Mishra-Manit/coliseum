    ...
    <div className="flex flex-col h-full min-h-0">
      ...
      <div className="flex items-center justify-between px-5 h-10 border-b border-border shrink-0">
        <div className="flex items-baseline gap-2.5">
          <span className={`${FontSize.small} font-mono ${O70.mutedText} tracking-[0.14em] uppercase`}>
            Cumulative P&L
          </span>
          {!isEmpty && (
            <span
      ...
      <div ref={mainRef} className="flex-[13] min-h-0 relative">
        {isEmpty && (
          <div className="absolute inset-0 flex items-center justify-center">
            <p className={`${FontSize.medium} font-mono ${O70.mutedText} tracking-[0.14em]`}>
              NO TRADE DATA YET
            </p>
          </div>
        )}
