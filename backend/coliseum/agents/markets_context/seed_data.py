...
MARKET_TYPES: dict[str, MarketTypeConfig] = {
    ...
    "KXRT": MarketTypeConfig(
        ...
        uses_slug=False,
        risk_questions=[
            "MANDATORY: Your research_topic query must explicitly ask for the 'All Critics Tomatometer score (NOT the audience/Popcornmeter score)'. These two scores frequently diverge by 10-30 points. Report both scores with explicit labels in your synthesis.",
            "What is the current Tomatometer (All Critics) score and critic review count? Also report the Audience Score (Popcornmeter) separately for comparison.",
            "Scores stabilize after ~100+ critic reviews — early Tomatometers with <30 reviews are highly volatile and can swing 15+ points",
            "When does the measurement window close? Late critic reviews can shift the Tomatometer before the Monday 10AM ET snapshot",
